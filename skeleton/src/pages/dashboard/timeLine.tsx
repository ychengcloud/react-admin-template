    ...
    return (
      <div className="customTooltip">
        ...
        <ul className="customTooltip-content">
          <li key="traffic">
            <Badge color={stroke1} />
            <FormattedMessage id="app.dashboard.timeline.traffic" /> {value1}
          </li>
          <li key="payments">
            <Badge color={stroke2} />
            <FormattedMessage id="app.dashboard.timeline.payments" /> {value2}
          </li>
        </ul>
      </div>
    );
      ...
      <ResponsiveContainer height={400}>
        <LineChart data={data} syncId="anyId">
          ...
          <Legend
            verticalAlign="top"
            height={40}
            formatter={value => <FormattedMessage id={('app.dashboard.timeline.' + value) as any} />}
          />
        </LineChart>
      </ResponsiveContainer>
    </Card>
